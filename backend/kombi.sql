...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2025 at 01:30 PM
...
CREATE TABLE `departures` (
  `id` int(11) NOT NULL,
  `days` set('1','2','3','4','5','6','7') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`id`, `tour_id`, `user_id`, `places`, `add_from`, `add_to`, `date`, `total`, `code`, `file_path`, `deleted`) VALUES
(1, 1, 1, 3, 'Gajeva 3', 'Primorska 5', '2025-07-02', 150, '3693691KP', NULL, 0),
(2, 1, 2, 2, 'Kočićeva 9', 'Zadarska 33', '2025-06-16', 100, '3693692KP', NULL, 0),
(3, 1, 3, 4, 'Krilova 6', 'Rudarska 99', '2025-06-27', 200, '3693693KP', NULL, 0),
(4, 4, 3, 1, 'Krilova 6', 'Rudarska 99', '2025-06-28', 75, '3693694KP', NULL, 0),
(5, 4, 2, 4, 'Ljubina 22', 'Glavna 3', '2025-06-26', 150, '3693695KP', NULL, 0),
(6, 4, 1, 5, 'Balkanska 6', 'Jurice Štovca 102', '2025-06-28', 300, '3693696KP', NULL, 0),
(7, 6, 2, 4, 'Kočićeva 6', 'Mornarska 99', '2025-07-01', 320, '3693697KP', NULL, 0),
(9, 6, 1, 2, 'Gajeva 6', 'Mornarska 99', '2025-07-01', 160, '3693698KP', NULL, 0);
...
CREATE TABLE `tours` (
  ...
  `departures` set('1','2','3','4','5','6','7') NOT NULL,
  `time` time NOT NULL,
...
(1, 'Novi Sad', 'Rijeka', '1,2,5,6,7', '06:45:00', 6, 50, 8, 0),
...
(6, 'Novi Sad', 'Split', '1,3,5,7', '06:45:00', 9, 80, 8, 0),
(7, '', '', '', '00:00:00', 0, 0, 0, 1);
...
(1, 'Mika', 'mika@test.com', '369963', 'Superadmin', 'Novi Sad', 'Gajeva 3', '062639963', '2025-05-22 20:07:25', '2025-05-22 20:07:25', NULL, NULL, 0),
(2, 'Žika', 'zile@test.com', '333999', 'Admin', 'Novi Sad', 'Kočićeva 6', '063936888', '2025-05-22 20:07:25', '2025-05-22 20:07:25', NULL, NULL, 0),
(3, 'Pera', 'pera@test.com', '999333', 'User', 'Beograd', 'Gandijeva 303', '069357951', '2025-05-22 20:07:25', '2025-05-22 20:07:25', NULL, NULL, 0),
...
(12, 'Valentina Djurdjevic', 'valentajndj@gmail.com', '$2y$10$rZ1jC98UFRtIwL1Dj3x.nuBwhvVwGjsDHPCAUlYD/J2DmyHGlGRlS', '', 'Sremska Kamenica', 'Gavrila Principa 6', '0641178898', '2025-06-24 13:26:48', '2025-06-24 13:26:48', 'ad030c511bb58a74373aaa1b42f8766108cbe38f2c301fb9590025cef27ae6d0', '2025-06-24 16:53:20', 0);
